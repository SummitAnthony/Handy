    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-full appearance-none cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
            background: `linear-gradient(to right, var(--color-accent) 0%, var(--color-accent) ${progressPercent}%, color-mix(in srgb, var(--color-text) 12%, transparent) ${progressPercent}%, color-mix(in srgb, var(--color-text) 12%, transparent) 100%)`,
          }}
        />
