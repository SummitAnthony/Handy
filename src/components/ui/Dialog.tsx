  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={`flex max-h-[calc(100dvh-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-2xl glass-dialog outline-none sm:max-h-[calc(100dvh-3rem)] ${className}`}
      >
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-hairline px-4 py-2.5">
          ...
          {dismissible && showCloseButton && (
            <button
              ...
              className="shrink-0 cursor-pointer rounded-full border border-transparent p-1 text-mid-gray transition-colors hover:bg-fill-hover hover:text-text focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
            >
